...
class ReporteService:
    ...
    async def generar_pdf(
        ...
        data = [
            ...
            ["Última actividad", row.ultima.strftime("%d/%m/%Y") if row.ultima else "Sin datos"],
        ]
        ...
        story.append(Paragraph(
            "Documento generado por LudusAcademia+. Datos protegidos conforme a la LGPDPPSO. "
            "El identificador del alumno es seudonimizado; el nombre real vive solo en el registro escolar.",
            footer_style,
        ))
