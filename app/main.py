...
async def server_error(request: Request, exc):
    return JSONResponse(
        status_code=503,
        content={"detail": "Error interno. Reintenta en 15 minutos.", "retry_after_seconds": 900},
    )
